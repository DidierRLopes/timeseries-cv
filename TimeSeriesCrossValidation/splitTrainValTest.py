...
def split_train_val_test_forwardChaining(sequence, n_steps_input, n_steps_forecast, n_steps_jump):
...
def split_train_val_test_kFold(sequence, n_steps_input, n_steps_forecast, n_steps_jump):
...
def split_train_val_test_groupKFold(sequence, n_steps_input, n_steps_forecast, n_steps_jump):
